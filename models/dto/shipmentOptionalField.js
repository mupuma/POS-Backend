class ShipmentOptionalFieldDTO {
    constructor(data = {}) {
        this.sequenceNumber = data.sequenceNumber || 0;
        this.optionalField = data.optionalField || '';
        this.value = data.value || '';
        this.shipmentOptionalFieldType = data.shipmentOptionalFieldType || 'Text';
    ...
    toJSON() {
        return {
            ...
            value: this.value,
            shipmentOptionalFieldType: this.shipmentOptionalFieldType,
            length: this.length,
